...
**Описание**: ShopWave — это веб-приложение для онлайн-покупок с каталогом товаров, корзиной, модальными окнами и оформлением заказа. Проект построен по архитектуре MVP (Model-View-Presenter), обеспечивая модульность и простоту масштабирования.
